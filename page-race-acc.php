        ...
        <div class="container-fluid">
            <div class="row">
                <section class="col-xs-12 col-sm-8 content-wrap">
                 <img class="img-icon-race img-race-acc lozad" data-src="<?php bloginfo('template_url'); ?>/images/race-icon-acc.png" alt="Race <?php the_title();?>">
                ...
                <div class="col-xs-12">
                    ...
                    <aside class="col-xs-12 col-sm-6 col-md-4">
                        <div class=" box-class text-center">
                            <img class="class-avatar lozad" data-src="<?php bloginfo('template_url'); ?>/images/acc-class-warrior.png" alt="" >
                            ...
                            <a href="<?php bloginfo('home');?>/accretia-warrior" class="btn btn-yellow btn-lg"><?php _e( "View Class", 'rfonline' );?></a>
                        </div>
                    </aside>
                    <aside class="col-xs-12 col-sm-6 col-md-4">
                        <div class=" box-class text-center">
                            <img class="class-avatar lozad" data-src="<?php bloginfo('template_url'); ?>/images/acc-class-ranger.png" alt="" >
                            <h4 class="class-title"><?php _e( "Ranger", 'rfonline' );?></h4>
                            <p class="class-overview">A basic melee fighter class, destined for more specialization in weapons and to wear heavy or light armor. At level 20, the Human Fighter must choose to be either a damage-based Warrior, a stealthy Rogue, or a defense-based Human Knight.</p>
                            <a href="<?php bloginfo('home');?>/accretia-ranger" class="btn btn-yellow btn-lg"><?php _e( "View Class", 'rfonline' );?></a>
                        </div>
                    </aside>
                    <aside class="col-xs-12 col-sm-6 col-md-4">
                        <div class=" box-class text-center">
                            <img class="class-avatar lozad" data-src="<?php bloginfo('template_url'); ?>/images/acc-class-specialist.png" alt="" >
                            <h4 class="class-title"><?php _e( "Specialist", 'rfonline' );?></h4>
                            <p class="class-overview">A basic melee fighter class, destined for more specialization in weapons and to wear heavy or light armor. At level 20, the Human Fighter must choose to be either a damage-based Warrior, a stealthy Rogue, or a defense-based Human Knight.</p>
                            <a href="<?php bloginfo('home');?>/accretia-specialist" class="btn btn-yellow btn-lg"><?php _e( "View Class", 'rfonline' );?></a>
                        </div>
                    </aside>
                </div>
            </div>
